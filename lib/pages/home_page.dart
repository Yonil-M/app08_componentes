      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            SizedBox(width: 200.0, child: Divider(),),
        const SizedBox(
                height: 10.0,
              ),
            
           /* ItemComponentWidget(titulo: "Avatar",),
            ItemComponentWidget(titulo:"Alert" ,),  
            ItemComponentWidget(titulo: "Cards",),  
            ItemComponentWidget(titulo: "Inputs",), 
            ItemComponentWidget(titulo: "List",), */
            ItemComponentWidget(
                titulo: "Avatar",
                toPage: AvatarPage(),
              ),
...
class ItemComponentWidget extends StatelessWidget {
 ...
 // ItemComponentWidget({required this.titulo});
  ...
  Widget build(BuildContext context) {
    return Container(
          ...
          color: Colors.black,
              ...
              subtitle: Text("ir al detalle de $titulo",
              style: GoogleFonts.poppins(),),
